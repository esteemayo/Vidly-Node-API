...
describe('/api/v1/courses', () => {
    ...
    describe('GET /', () => {
        ...
        it('should return all courses', async () => {
            ...
            expect(res.body.data.docs.some(c => c.category === 'mobile')).toBeTruthy();
            expect(res.body.data.docs.some(c => c.isPublished === true)).toBeTruthy();
            expect(res.body.data.docs.some(c => c.isPublished === false)).toBeTruthy();
    ...
    describe('PATCH /:id', () => {
        ...
        const exec = async () => {
            return request(server)
                ...
                .set('Authorization', `Bearer ${token}`)
                .send({ name: newName, category: newCategory, tags: newTags, isPublished: newIsPublished, price: newPrice });
        }
