...
describe('/api/v1/users', () => {
    ...
    describe('GET /', () => {
        ...
        it('should return all users in the collection', async () => {
            ...
            expect(res.body.data.docs.some(user => user.name === 'John Doe')).toBeTruthy();
            expect(res.body.data.docs.some(user => user.name === 'Mary Doe')).toBeTruthy();
            expect(res.body.data.docs.some(user => user.email === 'jdoe@example.com')).toBeTruthy();
            expect(res.body.data.docs.some(user => user.email === 'mdoe@example.com')).toBeTruthy();
            expect(res.body.data.docs.some(user => user.username === 'jdoe')).toBeTruthy();
            expect(res.body.data.docs.some(user => user.username === 'mdoe')).toBeTruthy();
            expect(res.body.data.docs.some(user => user.phone === 3456789)).toBeTruthy();
            expect(res.body.data.docs.some(user => user.phone === 456789256)).toBeTruthy();
        });
    });
