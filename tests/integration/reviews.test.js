...
describe('/api/v1/reviews', () => {
  let token, review, movieId, userId, id;
  ...
  describe('GET /', () => {
    ...
    it('should return all reviews', async () => {
      ...
      expect(
        res.body.data.docs.some((r) => r.review === 'Review1')
      ).toBeTruthy();
      expect(
        res.body.data.docs.some((r) => r.review === 'Review2')
      ).toBeTruthy();
  ...
  describe('GET /:id', () => {
    ...
    it('should return the review if valid id is passed', async () => {
      ...
      expect(res.body.data.doc).toHaveProperty(
        'movie',
        review.movie.toHexString()
      );
    });
  });

  describe('POST /', () => {
    let review, rating, movie, user;
  ...
  describe('PATCH /:id', () => {
    let newReview, newRating, newMovie, newUser;
