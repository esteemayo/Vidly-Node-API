...
describe('/api/v1/movies', () => {
    ...
    describe('GET /', () => {
        ...
        it('should return all the movies', async () => {
            ...
            expect(res.body.data.docs.some(m => m.numberInStock === 10)).toBeTruthy();
            expect(res.body.data.docs.some(m => m.numberInStock === 7)).toBeTruthy();
            expect(res.body.data.docs.some(m => m.numberInStock === 5)).toBeTruthy();
            expect(res.body.data.docs.some(m => m.dailyRentalRate === 2)).toBeTruthy();
            expect(res.body.data.docs.some(m => m.ratingsAverage === 4.5)).toBeTruthy();
            expect(res.body.data.docs.some(m => m.ratingsQuantity === 0)).toBeTruthy();
        });
    });
    ...
    describe('GET /:id', () => {
        ...
        it('should return the movie if valid id is passed', async () => {
            ...
            expect(res.body.data.doc).toHaveProperty('numberInStock', movie.numberInStock);
            expect(res.body.data.doc).toHaveProperty('dailyRentalRate', movie.dailyRentalRate);
        });
    });
    ...
    describe('PATCH /:id', () => {
        ...
        it('should return the updated movie', async () => {
            ...
            expect(res.body.data.doc).toHaveProperty('numberInStock', newNumberInStock);
            expect(res.body.data.doc).toHaveProperty('dailyRentalRate', newDailyRentalRate);
            expect(res.body.data.doc).toHaveProperty('ratingsAverage', newRatingsAverage);
            expect(res.body.data.doc).toHaveProperty('ratingsQuantity', newRatingsQuantity);
        });
    });
